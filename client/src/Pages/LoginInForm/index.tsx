...
import { AiOutlineMobile, AiOutlineLock, AiOutlineRight } from "react-icons/ai";
                  ...
                  <Form>
                    <div className="space-y-1">
                      ...
                      <div className="flex justify-between">
                        <div className="text-gray-400 mt-2 text-sm font-medium">RETRIEVE PASSWORD</div>
                        <Link to={'/'} className="text-gray-400 mt-2 text-sm font-medium flex items-center">REGISTER <AiOutlineRight /> </Link>
                      </div>
                    </div>
                  </Form>
                )}
